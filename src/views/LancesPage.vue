<template>
    <div class="card">
      <table>
        <thead>
          <tr>
            <th style="text-align: center; background-color: #14141f;">Grupo</th>
            <th style="text-align: center; background-color: #14141f;">Cota</th>
            <th style="text-align: center; background-color: #14141f;">Nome</th>
            <th style="text-align: center; background-color: #14141f;">Email</th>
            <th style="text-align: center; background-color: #14141f;">Documento</th>
            <th style="text-align: center; background-color: #14141f;">Tipo</th>
          ...
          <tr>
            <th><input type="text" v-model="filters.id" style="text-align: center;" placeholder="Grupo" /></th>
            <th><input type="text" v-model="filters.id" style="text-align: center;" placeholder="Cota" /></th>
            <th><input type="text" v-model="filters.name" placeholder="Nome" /></th>
            <th><input type="text" v-model="filters.email" placeholder="Email" /></th>
            <th><input type="text" v-model="filters.formattedDocument" placeholder="Documento" /></th>
            <th></th>
            <th></th>
            <th></th>
          </tr>
        ...
        <tbody>
          <tr v-for="offer in filteredOffers" :key="offer.id">
            <td style="text-align: center;">{{ offer.group }}</td>
            <td style="text-align: center;">{{ offer.quota }}</td>
            <td>{{ offer.name }}</td>
            <td>{{ offer.email }}</td>
            <td style="text-align: center;">{{ offer.formattedDocument }}</td>
            <td style="text-align: center;">{{ offer.type }}</td>
            <td style="text-align: center;">{{ offer.total }}</td>
